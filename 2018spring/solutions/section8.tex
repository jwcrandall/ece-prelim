...
\begin{aligned}
& \cos \delta_{c r}=\frac{1(141.31-28.43) \pi / 180+1.6 \cos \delta_{M M}}{1.6-1} \\
& \cos \delta_{c r}=\frac{1.9701-1.248-0.8794}{0.6} \\
& \left.\delta_{c r}=129.0685^{\circ}\right] \\
& t_{c r}=\left(\frac{2 \times 3}{\pi \times 60 \frac{(129.0685-28.93) \times \pi / 180}{1}}\right]^{1 / 2} . \\
& t_{c r}=0.23645 \mathrm{sec}
\end{aligned}
