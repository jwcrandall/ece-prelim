...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}[label={}]
            ...
            \item decimal 0.1 $\Rightarrow$ single precision 0 01111011 10011001100110011001101 
        \end{itemize}
        The final 1101 add additional precision after the 4 digit normalization shift. 
        
        \item To convert decimal 33554431 into single precision format (normalized) we first convert the integer in binary
    \end{enumerate}
    \item
    \begin{enumerate}
