...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        decimal: 0.1 $\Rightarrow$ single precision 0 01111011 10011001100110011001101 
        ...
        \item Take the whole number 33554431 and iteratively divide by 2 noting the quotient and remainder until a quotient of 0 is reached.\\ 
        ...
        Read the 25 bits from the bottom (Most Significant Bit $b_{24}$) to top (Least Significant Bit $b_{0}$). $(33554431)_{10} = (1111111111111111111111111)_{2}$
        
    \end{enumerate}
    
    \item
    \begin{enumerate}
        \item $0$ $01111011$ $10011001100110011001101_2$ = 
        \item $0$ $10011000$ $00000000000000000000000_2$ =
    \end{enumerate}
\end{enumerate}
